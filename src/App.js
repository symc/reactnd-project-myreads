    ...
    return (
      <div className="app">
        <Route exact path='/' render={() => (
          <ListBooks
            currentlyReadingBooks={this.getLibraryBooks('currentlyReadingBooks')}
            wantToReadBooks={this.getLibraryBooks('wantToReadBooks')}
            readBooks={this.getLibraryBooks('readBooks')}
          />
        )}/>
